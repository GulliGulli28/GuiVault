import { KIND_LABELS, type GuiVaultEntity, type GuiVaultEntityKind } from "./types";
...
// Les icônes personnalisées en plus de Guiterm : pas une entité aux yeux de
// l'utilisateur là-bas, mais ici on montre tout ce que le vault contient.
